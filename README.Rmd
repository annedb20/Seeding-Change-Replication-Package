...
* scripts/1_data_cleaning (link TBD) - Scripts for cleaning loaded data and preparing it for analysis.

* scripts/2_figures (link TBD) - Scripts for generating figures.

* scripts/3_tables (link TBD) - Scripts for generating select tables.

* scripts/4-stats (link TBD) - Scripts for generating select statistics.
